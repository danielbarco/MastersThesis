...
###############################################################################
def gt_boxes_from_xml(gt_img, verbose=False):
    '''
    Get ground truth locations from xml input:
...
def main():
    ...
    # create image list
    yolt_im_list_loc = os.path.join(args.out_dir, 'apizoom_' + str(sliceHeight) + '_training_list.txt')
    im_ext = '.jpg'
